...
.then(data => {
    ...
    document.getElementById("role").textContent = data.personal.role;
    document.getElementById("tagline").textContent = data.personal.tagline;
    ...
    document.getElementById("certificationBox").innerHTML = certifications;
